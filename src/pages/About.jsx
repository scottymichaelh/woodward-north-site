        ...
        <div className="wn-split-about" style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div>
            ...
            <p style={{ margin: "16px 0 0", font: "400 18px/1.65 Inter,sans-serif", color: "var(--wn-text-muted)", textWrap: "pretty" }}>
              I started Woodward North because the businesses I care about most, the Main Street ones with enduring legacies, usually get the
            ...
            <p style={{ margin: "16px 0 0", font: "400 18px/1.65 Inter,sans-serif", color: "var(--wn-text-muted)", textWrap: "pretty" }}>
              And with your lean team and an endless to-do list, the simplest things become the biggest burden. The books fall behind. 
              Tax season is around the corner. An acquisition entrepreneur, M&A advisor, or a local private equity firm calls to ask about your succession plan. 
            </p>
            <p style={{ margin: "16px 0 0", font: "400 18px/1.65 Inter,sans-serif", color: "var(--wn-text-muted)", textWrap: "pretty" }}>
            ...
            <p style={{ margin: "16px 0 0", font: "400 18px/1.65 Inter,sans-serif", color: "var(--wn-text-muted)", textWrap: "pretty" }}>
              What you need is a monthly close that lands on time. Someone who will walk you through the numbers and say what they mean in plain English. That's what Woodward North is about:
              bookkeeping done properly (Walk), then a conversation about what to do next (Run towards your goals).
            </p>
            <p style={{ margin: "16px 0 0", font: "400 18px/1.65 Inter,sans-serif", color: "var(--wn-text-muted)", textWrap: "pretty" }}>
              First build the financial foundation. Then dive deeper. Perhaps that's understanding your true cash flow numbers. 
              Or knowing what your business is actually worth. But it starts with a trusted partner who is genuinely interested in you, your business, and your success.
            </p>
