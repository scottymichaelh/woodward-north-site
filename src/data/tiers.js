...
export const svcAdvisory = [
  "Monthly performance review against budget and prior year",
  "13-week cash-flow forecast, updated with actuals",
  "KPI dashboard — the handful of numbers that move your business",
  "Working sessions on pricing, hiring and capital decisions",
  "Lender and investor reporting packages",
];

export const svcProjects = [
